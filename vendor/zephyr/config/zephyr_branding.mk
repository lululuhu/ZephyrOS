...
# ---------- 内部属性 (build.prop) — Android 13 版本 ----------
PRODUCT_PROPERTY_OVERRIDES += \
    ro.build.product=zephyr_gsi \
    ro.product.build.fingerprint=ZephyrOS/zephyr_gsi/zephyr:13/TQ3A.230801.001/zephyr01:userdebug/release-keys \
    ...
    ro.build.fingerprint=ZephyrOS/zephyr_gsi/zephyr:13/TQ3A.230801.001/zephyr01:userdebug/release-keys
...
# ---------- Android 版本号微调 (Android 13) ----------
PRODUCT_PROPERTY_OVERRIDES += \
    ro.build.id=TQ3A.230801.001 \
